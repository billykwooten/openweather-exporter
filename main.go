...
var (
	...
	apiKey      = app.Flag("apikey", "DarkSky API Key").Envar("OW_APIKEY").Required().String()
	city        = app.Flag("location", "City for Openweather to gather metrics from.").Envar("OW_LOCATION").Default("New York, NY").String()
